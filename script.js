...
const questions = [
  ...
  "（__）の実現に向けた授業改善を通して、創意工夫を生かした特色のある教育活動を展開する中で生徒に（生きる力）を育む事を目指すものとする",
  "（主体的・対話的で深い学び）の実現に向けた授業改善を通して、創意工夫を生かした特色のある教育活動を展開する中で生徒に（__）を育む事を目指すものとする",
  "(__)を確実に習得させ、これらを活用して課題を解決するために必要な(__)を育むとともに、主体的に学習に取り組む態度を養い、個性を生かし多様な人々との協働を促す教育の充実に努めること。その際、生徒の発達の段階を考慮して、生徒の(__)など、学習の基盤をつくる活動を充実するとともに、(__)を図りながら、生徒の学習習慣が確立するよう配慮すること。",
