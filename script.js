...
const questions = [
  ...
  "(__)を確実に習得させ、これらを活用して課題を解決するために必要な(思考力、判断力、表現力等)を育むとともに、(主体的に取り組む態度)を養い、個性を生かし多様な人々との協働を促す教育の充実に努めること。その際、生徒の発達の段階を考慮して、生徒の(言語活動)など、学習の基盤をつくる活動を充実するとともに、(家庭との連携)を図りながら、生徒の学習習慣が確立するよう配慮すること。",
  "(基礎的・基本的な知識及び技能)を確実に習得させ、これらを活用して課題を解決するために必要な(__)を育むとともに、(主体的に取り組む態度)を養い、個性を生かし多様な人々との協働を促す教育の充実に努めること。その際、生徒の発達の段階を考慮して、生徒の(言語活動)など、学習の基盤をつくる活動を充実するとともに、(家庭との連携)を図りながら、生徒の学習習慣が確立するよう配慮すること。",
  "(基礎的・基本的な知識及び技能)を確実に習得させ、これらを活用して課題を解決するために必要な(思考力、判断力、表現力等)を育むとともに、(__)を養い、個性を生かし多様な人々との協働を促す教育の充実に努めること。その際、生徒の発達の段階を考慮して、生徒の(言語活動)など、学習の基盤をつくる活動を充実するとともに、(家庭との連携)を図りながら、生徒の学習習慣が確立するよう配慮すること。",
  "(基礎的・基本的な知識及び技能)を確実に習得させ、これらを活用して課題を解決するために必要な(思考力、判断力、表現力等)を育むとともに、(主体的に取り組む態度)を養い、個性を生かし多様な人々との協働を促す教育の充実に努めること。その際、生徒の発達の段階を考慮して、生徒の(__)など、学習の基盤をつくる活動を充実するとともに、(家庭との連携)を図りながら、生徒の学習習慣が確立するよう配慮すること。",
  "(基礎的・基本的な知識及び技能)を確実に習得させ、これらを活用して課題を解決するために必要な(思考力、判断力、表現力等)を育むとともに、(主体的に取り組む態度)を養い、個性を生かし多様な人々との協働を促す教育の充実に努めること。その際、生徒の発達の段階を考慮して、生徒の(言語活動)など、学習の基盤をつくる活動を充実するとともに、(__)を図りながら、生徒の学習習慣が確立するよう配慮すること。",
  "...教育活動の充実を図るものとする。その際、生徒の(__)を踏まえつつ、次に掲げることが偏りなく実現できるようにするものとする。1(知識及び技能)が習得されるようにすること。2(思考力、判断力、表現力等)を育成すること。3(学びに向かう力、人間性等)を活養すること。",
  "...教育活動の充実を図るものとする。その際、生徒の(発達の段階や特性等)を踏まえつつ、次に掲げることが偏りなく実現できるようにするものとする。1(__)が習得されるようにすること。2(思考力、判断力、表現力等)を育成すること。3(学びに向かう力、人間性等)を活養すること。",
  "...教育活動の充実を図るものとする。その際、生徒の(発達の段階や特性等)を踏まえつつ、次に掲げることが偏りなく実現できるようにするものとする。1(知識及び技能)が習得されるようにすること。2(__)を育成すること。3(学びに向かう力、人間性等)を活養すること。",
  "...教育活動の充実を図るものとする。その際、生徒の(発達の段階や特性等)を踏まえつつ、次に掲げることが偏りなく実現できるようにするものとする。1(知識及び技能)が習得されるようにすること。2(思考力、判断力、表現力等)を育成すること。3(__)を活養すること。",
